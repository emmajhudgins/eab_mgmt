    ...
    for qq in range(0,3): 
            for bud in quar_bud:
               ...
               #Growth
                ...
                mgmt=pandas.io.parsers.read_csv("../../output/M_{0}_{1}_{2}_bud.csv".format(bud,eff_quar_in, eff_bio), header=None)#starting condition
        ...
        #       implement starting condition
                ...
                M3 = pandas.Series(M2)
                M4 = M3.unstack()
                M4.to_csv('../../output/vecptime_{0}_{1}_{2}_bud.csv'.format(bud,eff_quar_out,eff_bio), index=False,header=False)
