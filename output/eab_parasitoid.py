...
for rr in range(0,3):
    for qq in range(0,3):
        ...
        mgmt=pandas.io.parsers.read_csv("../../output/management_test_0_1_{0}_{1}_.csv").format(eff_quar_in, eff_bio)
        ...
        m.write('../../output/modelstart_{0}_{1}_{2}.sol'.format(eff_quar_in,eff_quar_out,eff_bio))