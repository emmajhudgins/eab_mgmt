...
frac_site=0.4
frac_spread=0.6
results<-read.csv(paste('~/Desktop/OneDrive - McGill University/GitHub/eab_mgmt/output/management_test_0.2_0.8_0.3_0.1_.csv'))
pdf(paste("~/Desktop/OneDrive - McGill University/GitHub/eab_mgmt/plots/RoT_eab_mgmt_site_0.2_0.8",qin, qbio,".pdf", sep="_"))
...
frac_site=0.2
frac_spread=0.8
results<-read.csv(paste('~/Desktop/OneDrive - McGill University/GitHub/eab_mgmt/output/vecptime_0.3_0.1.csv'))/1000
time<-seq(1:6)
...
par(mar=c(4,4,2,2))
plot(y=obj$obj,x=(obj$frac_site), col=alpha(viridis(9)[as.factor(paste0(obj$q_in, obj$qbio))],0.75), xlab="Site-focused budget proportion", ylab="Exposed ash street trees", pch=19, xlim=c(-0.05,1.05), ylim=c(100000,1200000))
...
points(x=c(0.1,0.3,0.5), y=c(1233200,1035330, 729520),col=viridis(27)[c(18)], pch=23) 
legend('topright', legend=c("All Management", "Biocontrol Only"), pch=c(19,23), col=viridis(27)[c(13,18)], cex=0.75)
